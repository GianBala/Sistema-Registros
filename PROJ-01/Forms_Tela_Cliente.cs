...
namespace PROJ_01
{
    public partial class Tela_Inicial_Cliente : Form, IUsuarioAtivo
    {
        Tela_Login tela;
        public Usuario IUsuarioAtivo { get; set; }
        private bool isClosingProgrammatically = false;
        bool SideBarExpand = false;
        public Tela_Inicial_Cliente(Tela_Login tela)
        {
            this.tela = tela;
            this.FormClosing += new FormClosingEventHandler(Tela_Inicial_Cliente_FormClosing);
            InitializeComponent();
        }
        ...
        private void Tela_Inicial_Cliente_FormClosing(object sender, FormClosingEventArgs e)
        {
